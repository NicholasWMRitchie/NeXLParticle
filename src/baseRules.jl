const BaseRules = OrderedRuleSet(
    ...
    "Maraging" => r -> isequal(r.FIRSTELM, n"Fe") && (r.NI > 5) && (r.CO > 2) && sum(r, :FE, :NI, :CO, :MO) > 80.0,
    "Quartz-like" => r -> r.SI > 80,
    "Biotite" => r -> (r.K > 5) && (r.MG + r.FE > 20) && (r.AL > 10) && (r.SI > 10) && (r.K + r.MG + r.FE + r.AL + r.SI > 80) && (r.O > 5),
    "Plagioclaise" => r -> (r.CA + r.NA > 20) && (r.AL > 10) && (r.SI > 10) && (r.NA + r.CA + r.AL + r.SI > 80) && (r.O > 5),
    "Othoclaise" => r -> (r.K > 5) && (r.AL > 20) && (r.SI > 20) && (r.O > 10) && (r.K + r.AL + r.SI > 80),
    "Dolomite" => r -> (r.CA > 40) && (r.MG > 10) && (r.CA + r.MG > 70),
    "Olivine" => r -> (r.MG + r.FE > 40) && (r.SI > 20) && (r.MG + r.FE + r.SI > 80),
    "Feldspar" => r -> (r.K + r.NA + r.CA > 20) && (r.AL > 10) && (r.SI > 20) && (r.K + r.NA + r.CA + r.AL + r.SI > 80),
    "Willemite" => r -> (r.ZN > 20) && (r.SI > 20) && (r.ZN + r.SI > 80),
    "Garnet" => r -> (r.MG + r.FE + r.MN + r.CA > 10) && (r.AL > 5) && (r.SI > 10) && (r.MG + r.FE + r.MN + r.CA + r.AL + r.SI > 80),
    "Al-Cu alloy (2XXX)" => r -> (r.AL > 60) && isequal(r.SECONDELM, n"Cu") && (r.CU > 3) && (r.AL + r.CU > 90),
    "Al-Mn alloy (3XXX)" => r -> (r.AL > 60) && isequal(r.SECONDELM, n"Mn") && (r.MN > 3) && (r.AL + r.MN > 90),
    "Al-Si alloy (4XXX)" => r -> (r.AL > 80) && isequal(r.SECONDELM, n"Si") && (r.SI > 1) && (r.AL + r.SI > 90),
    "Al-Mg alloy (5XXX)"  => r -> isequal(r.FIRSTELM, n"Al") && isequal(r.SECONDELM, n"Mg") && (r.MG > 5) && (r.AL + r.MG > 80),
    "Al-Si-Mg (6XXX)"  => r -> (r.AL > 90) && (r.SI > 0) && (r.MG > 0) && (r.AL + r.SI + r.MG + r.MN + r.CU + r.FE > 98),
    "Al-Zn alloy (7XXX)" => r -> (r.AL > 80) && isequal(r.SECONDELM, n"Zn") && (r.ZN > 2) && (r.AL + r.ZN > 90),
    "Al-Fe alloy" => r -> (r.AL > 80) && isequal(r.SECONDELM, n"Fe") && (r.FE > 2) && (r.AL + r.FE > 90),
    "Aluminosilicate" =>  r -> (r.AL > 30) && (r.SI > 10) && (r.AL + r.SI > 80),
    "Zircon" =>  r -> (r.ZR > 20) && (r.ZR + r.SI > 80),
    "Elgiloy" => r -> (r.CO > 20) && (r.CR > 10) && (r.NI > 5) && (r.FE > 5) &&  ((r.MO > 2) || (r.S > 2)) && (r.CO + r.CR + r.NI + r.FE + r.MO + r.MN + r.S > 80),
    "Aluminum" => r -> r.AL > 80,
    ...
    "Fe-Cr-Ni Stainless" => r -> isequal(r.FIRSTELM, n"Fe") && (r.CR > 5) && (r.NI > 5) && (r.FE + r.CR + r.NI > 80),
    "Fe-Ni stainless" => r -> (r.FE > 50) && (r.NI > 10) && (r.FE + r.NI > 90),
    "Iron oxide" => r -> (r.FE > 80) && (r.O > 10),
    "Iron" => r -> r.FE > 80,
    "Calcite" => r -> (r.CA > 80) && (r.O > 5),
    "Zinc" => r -> r.ZN > 80,
    "Silicate" => r -> isequal(r.FIRSTELM, n"Si"),
    "Anglesite" => r -> isequal(r.FIRSTELM, n"Pb") && isequal(r.SECONDELM, n"S") && (r.PB + r.S > 80) && (r.O > 5),
    ...
    "Sn62 solder" => r -> (r.SN > 30) && (r.PB > 10) && (r.AG > 1) && (r.SN + r.PB + r.AG > 80),
    "SACZ solder" => r -> (r.SN + r.AG + r.CU + r.ZN > 80) && (r.SN > 10) && (r.CU > 10) && (r.AG > 10) && (r.ZN > 2),
    "Lead solder" => r -> (r.PB > 20) && (r.SN > 20) && (r.PB + r.SN > 80),
    "SAC solder" => r -> (r.SN + r.AG + r.CU > 80) && (r.SN > 10) && (r.CU > 10) && (r.AG > 10),
    "Titanium" => r -> (r.TI > 80),
    ...
    "Gold-Silver alloy" => r -> isequal(r.FIRSTELM, n"Au") && isequal(r.SECONDELM, n"Ag") && (r.AU + r.AG > 80),
...
const NullRules = OrderedRuleSet("Null",  Pair{String, Function}[ "Unclassified" => (_ -> true) ] )